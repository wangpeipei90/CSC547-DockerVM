#!/usr/bin/Rscript
old=getwd();
basedir="/home/peipei/course/CSC547/experiment_docker_hadoop/output_launch_dockerhadoopprogram";
setwd(basedir);
...
for(col_num in 1:length(X)){
 ...
 # print(average)
  # print(value1)
  plot(x=x_axis,y=NULL,ylim=c(v_min,v_max),type="n",main="Overhead of running Hadoop MapReduce GREP inside Docker container",xlab="time(seconds)",ylab=metrics_meaning[[name1]],col="black");
